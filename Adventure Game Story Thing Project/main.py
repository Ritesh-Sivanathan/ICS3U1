...
def Interrogation():
    ...
    if offer.strip().lower() == "accept":
        ...
        call_lawyer = (input("Once you get home, do you call your lawyer, or ignore what happened? (lawyer/ignore): "))
        ...
        if call_lawyer.strip().lower() == "lawyer":
            ...
            publicize_or_not = input("Do you want to go public? (yes/no): ")
